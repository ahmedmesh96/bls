...
class GroupChatRoom extends StatelessWidget {
  ...
  Future getImage({required name}) async {
  ...
  Future uploadImage({required name}) async {
...
//******************************* */
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            suffixIcon: IconButton(
                              onPressed: () =>
                                  getImage(name: allMyDataFromDB!.name),
  ...
  Widget messageTile(
      {required size, required chatMap, required name, required profileImg}) {
